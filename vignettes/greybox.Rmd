...
8. [ro()](ro.html) - produce forecasts with a specified function using rolling origin.
9. `rmc()` - regression for multiple comparison of methods. This is a parametric counterpart of `nemenyi()`, which should work better than `nemenyi()` on large samples.
