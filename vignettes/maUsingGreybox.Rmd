...
This plot demonstrates, for example, that the number of carburetors influences fuel consumption (something that we could not have spotted in the case of `plot()`). Notice also, that the number of gears influences the fuel cosumption in a non-linear relation as well. So constructing the model with dummy variables for the number of gears might be a reasonable thing to do.
