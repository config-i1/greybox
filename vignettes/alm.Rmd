...
When working with non-conventional loss functions do not rely on standard errors of parameters too much, because they are not what they seem: they only work in case of `loss="likelihood"`. A correct method for calculating the standard errors would be a bootstrap, but this is not yet supported in `greybox`.
