...
\begin{equation} \label{eq:CDFLevelALM}
    q_t = a_t + \eta_t ,
\end{equation}
and it can be transformed to the probability with $p_t = g(q_t)$. So the aim of all the functions is to estimate the $a_t$ and transform it to the estimate of the probability $\hat{p}_t$.
