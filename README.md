...
1. determination - the function returns the vector of coefficients of determination (R^2) for the provided data. This is useful for the diagnostics of multicollinearity.
2. graphmaker - plots the original series, the fitted values and the forecasts.
3. tableplot - plots the graph for two categorical variables.
4. spread - plots the matrix of scatter / boxplot / tableplot diagrams - depending on the type of the variable.
